...
<?php require_once 'includes/update-user.php'; ?>
<?php // Allow only Admins
    ...
    if (isset($_GET['user_id'])) {
        ...
        $user_id = sanitizeAndValidateQueryString($_GET['user_id']);
        // dd($user_id);
                                    ...
                                    <form method="post">
                                        <div class="row g-3 mb-3">
                                          <div class="col">
                                            ...
                                            <input type="text" name="fname" class="form-control" placeholder="First name" aria-label="First name" value="<?php echo $user['fname'] ?? ''; ?>">
                                            <div class="text-danger"><?php echo $errors['fname'] ?? ''  ?></div>
                                          </div>
                                          <div class="col">
                                            <label for="exampleInputEmail1" class="form-label">Last Name</label>
                                            <input type="text" name="lname" class="form-control" placeholder="Last name" aria-label="Last name" value="<?php echo $user['lname'] ?? ''; ?>">
                                          ...
                                          <div class="row">
                                              ...
                                              <div class="col mb-3">
                                                  ...
                                                  <?php  $role = usernameExit('roles', 'id', $user['role_id']);
 ?>
                                          ...
                                          <div class="row g-3 mb-3">
                                              <div class="col">
                                                ...
                                                <input type="text" name="user_number" class="form-control" placeholder="Matric/Employee ID" id="user_number" value="<?php echo $user['user_number'] ?? ''; ?>">
                                                 <div class="text-danger"><?php echo $errors['user_number'] ?? ''  ?></div>
                                              </div>
                                              <div class="col">
                                                <label for="user_number" class="form-label">Department</label>
                                                <input type="text" name="dept" class="form-control" placeholder="Department" value="<?php echo $user['dept'] ?? ''; ?>">
                                                <input type="hidden"  name="user_id" value="<?php echo $user['id'] ?>">
                                              </div>
                                            </div>
                                          <div class="row d-flex justify-content-between">
                                              <button type="submit" name="createUser" class="btn btn-primary">Update</button>
