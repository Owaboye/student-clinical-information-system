                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                      <h5>Student Info</h5>
                                        ...
                                        <hr>
                                        <h5>Staff Info</h5>
                                        <p><strong>Name:</strong> <?= htmlspecialchars($consultation['staff_name']) ?>  
                                        </p>
                                        <hr>
                                        
                                        <h5>Consultation </h5>
                                        <p><strong>Status: <?= htmlspecialchars($consultation['status']) ?></strong>   
                                        </p>
                                        <hr>
                                        <h5>Date</h5>
...
<div class="no-print mt-4">
  <a href="consultations_list.php" class="btn btn-secondary">Back to List</a>
</div>
